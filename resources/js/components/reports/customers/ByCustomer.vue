<template>
    <div class="modal fade" id="ByCustomerModal" role="dialog" aria-labelledby="edit-event-label" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col text-center">
                            <h4 class="">Lista actividades por cliente</h4>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        handleExport: function () {
            ...
            axios.get(`${this.appUrl}api/reports/customers/activities-customer`,{
                params: {
