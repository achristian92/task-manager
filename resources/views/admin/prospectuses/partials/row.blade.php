<tr>
    ...
    <td class="text-right">
        @include('components.row-show', ['route' => route('admin.prospectuses.show',$customer->id)])
        @include('components.row-edit', ['route' => route('admin.prospectuses.edit',$customer->id)])
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                <form action="{{ route('admin.prospectuses.destroy', $customer->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
