...
namespace App\Http\Controllers\Admin\Prospectuses;
...
class ProspectusController extends Controller
{
    ...
    {
        return view('admin.prospectuses.index', [
            'prospectuses' => $this->customerRepo->listAllCustomers()
        ]);
    }
    ...
    {
        return view('admin.prospectuses.create',[ 'model' => new Customer ]);
    }
    ...
    public function store(CustomerRequest $request)
    {
        ...
        return redirect()->route('admin.prospectuses.index')->with('success','Nuevo cliente creado.');
    }

    public function edit(Customer $customer)
    {
        return view('admin.prospectuses.edit',[ 'model' =>$customer ]);
    }

    public function show(Customer $prospectus)
    {
        $date = $this->getDateFormats(request()->input('yearAndMonth'));

        $activities = $this->activityRepo->listActivityByCustomer($prospectus->id,$date['from'],$date['to'])
    ...
    public function update(CustomerRequest $request, Customer $customer)
    {
        ...
        return redirect()->route('admin.prospectuses.index')->with('success','Cliente actualizado.');
    }
    ...
    {
        $prospectuses = $this->customerRepo->listAllCustomers();
        return \Excel::download(new CustomerExport($prospectuses),'Lista-Clientes.xlsx');
    }
    ...
    public function import(Request $request)
    {
        ...
        return redirect()->route('admin.prospectuses.index')->with('success', 'Información cargada');
    }
    ...
    public function deleteFile(Customer $customer, File $file)
    {
        ...
        return redirect()->route('admin.prospectuses.show',$customer->id)->with('success', 'Documento eliminado');
    }
