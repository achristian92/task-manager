...
class CustomerTotalHoursByMonth implements FromView,WithDrawings,ShouldAutoSize,WithCustomStartCell,WithEvents
{
    private $data;
    private $month;
    private $dates;

    public function __construct(array $data,array $period, string $month)
    {
        $this->data    = $data;
        $this->dates   = $period;
        $this->month   = $month;
    ...
    {
        return view('admin.reports.customer.total-hours-by-month', [
            'customers' => $this->data,
                'dates' => $this->dates,
