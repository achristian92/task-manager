...
class ActivitiesByTagExport  implements FromView,WithDrawings,ShouldAutoSize,WithCustomStartCell,WithEvents
{
    ...
    {
        return view('admin.reports.customers.activity-by-tag', [
            'tags'               => $this->data,
