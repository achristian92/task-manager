...
class WorkplanDaysExport implements FromView,WithDrawings,ShouldAutoSize,WithCustomStartCell,WithEvents
{
    private $data;
    private $user;
    private $month;
    ...
    public function __construct(array $data,array $rangedays, string $user, string $month)
    {
        $this->data  = $data;
    ...
    {
        return view('reports.users.workplan-days', [
            'data'  => $this->data,
            'dates' => $this->dates,
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($style) {
                ...
                $event->sheet->getDelegate()
                    ->setCellValue('b6',"Usuario: $this->user")
